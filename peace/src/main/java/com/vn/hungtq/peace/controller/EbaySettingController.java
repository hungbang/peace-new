...
public class EbaySettingController {
    ...
    public
    @ResponseBody
    ItemInfomationDto loadItemInfomation(HttpServletRequest request) {
    ...
    public void FactionDownloadSampleTemplate(HttpServletResponse response) {
        ClassLoader classLoader = getClass().getClassLoader();
        File file = new File(classLoader.getResource("sampletemplate.html").getFile());
    ...
    public
    @ResponseBody
    AjaxResponseResult<String> addNewItemInfomation(@RequestBody ItemInfomationDto itemInfomation, HttpServletRequest request) {
        //Log
    ...
    public
    @ResponseBody
    AjaxResponseResult<String> uploadTemplate(@RequestBody UserTemplateDto templateUploadDto,
    ...
    public
    @ResponseBody
    List<List<UserTemplateDto>> loadUserTemplates(HttpServletRequest request) {
        authentication = SecurityContextHolder.getContext().getAuthentication();
        UserDto user = CommonUtils.getUserFromSession((User) authentication.getPrincipal(), userService);
        int userId = user.getId();
    ...
    public
    @ResponseBody
    AjaxResponseResult fetchTokenActionPerformed(
