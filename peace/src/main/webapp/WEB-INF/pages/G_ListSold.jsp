...
" >
    ...
    border-top-style: solid;">
                    <div>
                        ...
                        <div>
                        	<section id="widget-grid" class="" ng-controller="listSoldController">
				<div>
	...
	<script type="text/javascript">
		...
		listSoldApp.controller("listSoldController", function($scope, $http) {
			$scope.loadListSold = function() {
				$http.get("GetListProduct/3").success(
						function(data, status, headers, config) {
							$scope.listSold = data.extraData;
